...
const { isCatalogueIntent, wantsCatalogueImages, extractFilters, normalizeText, primaryImage, allImages, normalizeImageUrl, isCompleteCatalogueRequest } = require('./agent');
...
test('complete catalogue gets 20 product limit', () => assert.equal(extractFilters('complete catalogue'), { fabric: '', color: '', collection: '', name: '', limit: 20 }));
